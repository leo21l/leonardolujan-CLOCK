...
void temp_mode()
{
  char buffer[4];   //for int to char conversion to turn rtc values into chars we can print on screen
  ...
  while (run_mode()) {
    ...
    // Parse the temperature into 3 digits:
    int tempInt = itoa((int)(f*10), buffer, 10);
    putnormalchar(1, 0, buffer[0]);
    putnormalchar(7, 0, buffer[1]);
    putnormalchar(13, 0, buffer[2]);
    // TODO:  Add decimal point here
    putnormalchar(19, 0, buffer[3]);
  }
  fade_down();
}
